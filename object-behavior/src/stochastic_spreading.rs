...
mod tests {
    ...
    fn spreads_when_chance_is_hit() {
        ...
        world_interactor
            .expect_find_objects_in_area(partial_eq(Aabb::try_new((34.0, 34.0), (44.0, 44.0)).unwrap()))
            .returns(Vec::new());
    ...
    fn does_not_spread_when_surrounded() {
        ...
        world_interactor
            .expect_find_objects_in_area(partial_eq(Aabb::try_new((45.0, 34.0), (55.0, 44.0)).unwrap()))
            .returns(vec![Object {
                id: 1,
        ...
        world_interactor
            .expect_find_objects_in_area(partial_eq(Aabb::try_new((56.0, 34.0), (66.0, 44.0)).unwrap()))
            .returns(vec![Object {
                id: 2,
        ...
        world_interactor
            .expect_find_objects_in_area(partial_eq(Aabb::try_new((56.0, 45.0), (66.0, 55.0)).unwrap()))
            .returns(vec![Object {
                id: 3,
        ...
        world_interactor
            .expect_find_objects_in_area(partial_eq(Aabb::try_new((56.0, 56.0), (66.0, 66.0)).unwrap()))
            .returns(vec![Object {
                id: 4,
        ...
        world_interactor
            .expect_find_objects_in_area(partial_eq(Aabb::try_new((45.0, 56.0), (55.0, 66.0)).unwrap()))
            .returns(vec![Object {
                id: 5,
        ...
        world_interactor
            .expect_find_objects_in_area(partial_eq(Aabb::try_new((34.0, 56.0), (44.0, 66.0)).unwrap()))
            .returns(vec![Object {
                id: 6,
        ...
        world_interactor
            .expect_find_objects_in_area(partial_eq(Aabb::try_new((34.0, 45.0), (44.0, 55.0)).unwrap()))
            .returns(vec![Object {
                id: 7,
